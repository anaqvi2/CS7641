...
2. The code for this analysis is a jupyter notebook (HW1_FULL_CODE.ipynb), I generate both datasets, and perform the analysis for both datasets inside the same notebook
